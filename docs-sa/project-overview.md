...
- [Source Agents: Project Overview](#source-agents-project-overview)
  ...
  - [Development Roadmap](#development-roadmap)
    ...
    - [Phase 2: Expansion (Months 7-12)](#phase-2-expansion-months-7-12)
    - [Phase 3: Universe Building (Months 13-18)](#phase-3-universe-building-months-13-18)
    - [Phase 4: Ecosystem Maturity (Months 19-24)](#phase-4-ecosystem-maturity-months-19-24)
    - [Phase 5: Broader Cultural Reach (Year 3+)](#phase-5-broader-cultural-reach-year-3)
  - [Business Model \& Monetization](#business-model--monetization)
    - [Revenue Streams](#revenue-streams)
    - [Free-to-Play Philosophy](#free-to-play-philosophy)
  - [Target Audience](#target-audience)
    - [Primary Audiences](#primary-audiences)
    - [Secondary Audiences](#secondary-audiences)
  - [Marketing \& Community Strategy](#marketing--community-strategy)
    - [Pre-Launch (Months 1-3)](#pre-launch-months-1-3)
    - [Launch (Months 4-6)](#launch-months-4-6)
...
**Goal:** Launch Source Agent: ALICE with complete first story arc

**Deliverables:**
- 3-5 chapters with branching narrative
- Multiple endings (3-4 distinct paths)
- On-chain NFT integration (chapters, endings, key choices)
- Community building and early player feedback
- Documentation and open-source components

**Milestones:**
- Month 1-2: Core narrative engine and first chapter
- Month 3-4: Complete story content and branching logic
- Month 5: On-chain integration and testing
- Month 6: Beta testing, polish, launch

---

### Phase 2: Expansion (Months 7-12)
**Goal:** Extend ALICE, begin BYRON development

**Deliverables:**
- ALICE: 2-3 additional chapters/story routes
- BYRON: Core gameplay prototype (combat, exploration, dialogue)
- Cross-game NFT utility established
- Growing community and player base

**Milestones:**
- Month 7-8: ALICE content expansion
- Month 9-10: BYRON prototype and first vault
- Month 11-12: BYRON alpha with 2-3 vaults playable

---

### Phase 3: Universe Building (Months 13-18)
**Goal:** Release BYRON, prototype CAROL
...
**Goal:** Complete initial trilogy, advanced features

**Deliverables:**
- All three characters have at least one complete game
- Advanced cross-game features (choices in ALICE unlock items in BYRON, etc.)
- Tournament infrastructure for competitive play
- Potential new protagonists or spin-off concepts

**Milestones:**
- Month 19-20: Cross-game integration depth
- Month 21-22: Tournament systems and competitive features
- Month 23-24: Evaluate franchise expansion directions

---

### Phase 5: Broader Cultural Reach (Year 3+)
**Goal:** Mainstream expansion and studio collaboration

**Potential Directions:**
- Cross-platform ports (mobile, desktop native)
- Collaboration with established game studio for beat-'em-up spin-off featuring all three Agents
- Additional characters/series (DIANA, ETHAN, etc.)
- Animated shorts or other media exploring the lore
...
- **Web3 Role:** Optional (core game playable without wallet; blockchain for leaderboards, cosmetics, lore unlocks)
- **Strategic Benefit:** Gateway title that attracts traditional gamers, introduces them to lore, funnels to web3-native games
...
- Discord server for lore discussion and player coordination
- Fan art contests
- "Which Agent are you?" personality quiz
- Speedrun challenges with prizes
...
- Seasonal events
- Player-generated content features
...
**Normalization through entertainment.** Players internalize proactive, reactive, and foundational security mindsets through gameplay—learning by being, not by memorizing. Makes security thinking accessible and engaging without being preachy.
...
**Risk:** Low Web3 gaming adoption  
**Mitigation:** Design for gameplay-first (can play without wallet), target indie game audience, free-to-play core

**Risk:** Blockchain negative perception  
...
**Risk:** Solo/small team bandwidth  
**Mitigation:** Open-source components, community contributions, targeted contractor hires for specialized needs, strategic partnerships
